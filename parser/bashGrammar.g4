...
bashScript			:	(function_call | function_def | loops | assignment | linux_command | space | advanced_assignment | ifElse)+;
...
command_data 		: 	(BLOB | INCREMENT | string | BASH_VAR | VAR | VAL | RHS_ASSIGNMENT | OTHER)+ space?;
